...
<?php else: ?>
	...
	<fieldset class="set">
		<p class="guide"><?php echo sprintf(__('As of March 2013, Twitter.com is shutting down v1.0 of its API. What this means for you, is that it is now more complicated to simply display some tweets on your website using the -=CI Tweets=- widget. You will now need to follow a series of steps in order to allow Twitter capabilities to your website. First, <a href="%s">log into the Twitter Developers website</a>.', 'ci_theme'), 'https://dev.twitter.com/apps'); ?></p>
