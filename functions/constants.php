...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'IgnitionConf-Runder');
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=52&t=2377');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=52');
